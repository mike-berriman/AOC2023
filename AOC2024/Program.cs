namespace AOC2024
{
    ...
    {
        const string fileName = @"D:\temp\advent\AOC2024\Day14\TestData1.txt";
        const string fileName2 = @"D:\temp\advent\AOC2024\Day14\InputData.txt";

        List<Day14> inputObjects = new List<Day14>();
        Day14 mainObject = null;

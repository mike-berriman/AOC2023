namespace AOC2024
{
    ...
    {
        const string fileName = @"D:\temp\advent\AOC2024\Day13\TestData1.txt";
        const string fileName2 = @"D:\temp\advent\AOC2024\Day13\InputData.txt";

        List<Day13> inputObjects = new List<Day13>();
        Day13 mainObject = null;

namespace AOC2024
{
    ...
    {
        const string fileName = @"D:\temp\advent\AOC2024\Day6\TestData1.txt";
        const string fileName2 = @"D:\temp\advent\AOC2024\Day6\InputData.txt";

        List<Day6> inputObjects = new List<Day6>();
        Day6 mainObject = null;

namespace AOC2024
{
    ...
    {
        const string fileName = @"D:\temp\advent\AOC2024\Day4\TestData1.txt";
        const string fileName2 = @"D:\temp\advent\AOC2024\Day4\InputData.txt";

        List<Day4> inputObjects = new List<Day4>();
        Day4 mainObject = null;

namespace AOC2024
{
    ...
    {
        const string fileName = @"D:\temp\advent\AOC2024\Day5\TestData1.txt";
        const string fileName2 = @"D:\temp\advent\AOC2024\Day5\InputData.txt";

        List<Day5> inputObjects = new List<Day5>();
        Day5 mainObject = null;
